...
<body>
    ...
    <div style="background-image: url('src/img/hero-bg.png');background-position: center;background-repeat: no-repeat;background-size: cover; padding: 160px 0px" class=" h-100 text-center d-flex flex-column justify-content-center align-items-center gap-4">
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-center" class="fw-bold col-10 col-lg-6 hero-title">Yayasan <span class="primary-color">Sayyidul Hasaniyah</span></div>
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-center" class="fw-normal col-10 col-lg-6 hero-subtitle">
            Berperan menciptakan masa depan cerah bagi anak yatim melalui akses pendidikan, kesehatan, dan perlindungan.</div>
        <a href="#pe" data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-center" class="btn bg-primary-color mt-3 link-decoration-none">Pelajari lebih lanjut</a>
    </div>

    <div id="pe" class="container py-5">
        <div class="text-center fs-1 fw-bold">Program Unggulan</div>
        <div class="row row-cols-1 row-cols-md-2 gy-5 g-lg-5 mt-0 text-center justify-content-center">
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" class="d-flex flex-column justify-content-center align-items-center">
                <div><img src="src/img/01.png" class="rounded-circle object-cover" width="200" height="200" alt="Exhibition Image"></div>
                <div class="fs-2 fw-semibold">Program Pendidikan</div>
                <div class="col-9 ">Menyediakan beasiswa pendidikan bagi anak-anak yatim dari tingkat Sekolah Dasar (SD) hingga Sekolah Menengah Atas (SMA)</div>
            </div>
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" class="d-flex flex-column justify-content-center align-items-center">
                <div><img src="src/img/02.jpg" class="rounded-circle object-cover" width="200" height="200" alt="Exhibition Image"></div>
                <div class="fs-2 fw-semibold">Program Kesehatan</div>
                <div class="col-9 ">Program ini juga mencakup memberikan layanan kesehatan gratis dan penyuluhan kesehatan kepada anak-anak yatim dan keluarganya.</div>
            </div>
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" class="d-flex flex-column justify-content-center align-items-center">
                <div><img src="src/img/03.png" class="rounded-circle object-cover" width="200" height="200" alt="Exhibition Image"></div>
                <div class="fs-2 fw-semibold">Program Pembinaan</div>
                <div class="col-9 ">Mengadakan kegiatan pembinaan karakter, keterampilan, dan kewirausahaan bagi anak-anak yatim.</div>
            </div>
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" class="d-flex flex-column justify-content-center align-items-center">
                <div><img src="src/img/04.png" class="rounded-circle object-cover" width="200" height="200" alt="Exhibition Image"></div>
                <div class="fs-2 fw-semibold">Program Kemitraan</div>
                <div class="col-9 ">Berkolaborasi dengan berbagai lembaga dan perusahaan untuk memberikan pelatihan kerja dan kesempatan kerja bagi anak-anak yatim yang telah dewasa.</div>
            </div>
        </div>
    </div>
    ...
    <!-- Footer -->
    <div class="bg-white">
        <div class="py-5 container d-flex flex-column flex-lg-row gap-5">
