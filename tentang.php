...
<body>
    ...
    <!-- <div style="background-image: url('src/img/hero-bg.png');background-position: center;background-repeat: no-repeat;background-size: cover; padding: 160px 0px" class=" h-100 text-center d-flex flex-column justify-content-center align-items-center gap-4">
        <div data-aos="fade-up" data-aos-duration="1000"" class="fw-bold col-10 col-lg-6 hero-title">Yayasan <span class="primary-color">Sayyidul Hasaniyah</span></div>
        <div data-aos="fade-up" data-aos-duration="1000"" class="fw-normal col-10 col-lg-6 hero-subtitle">
            Berperan menciptakan masa depan cerah bagi anak yatim melalui akses pendidikan, kesehatan, dan perlindungan.</div>
        <a href="#pe" data-aos="fade-up" data-aos-duration="1000"" class="btn bg-primary-color mt-3 link-decoration-none">Pelajari lebih lanjut</a>
    </div> -->
